...
bool syntacticParse()
{
    ...
    string possibleMatrixQuery = tokenizedQuery[1];
    if(possibleMatrixQuery == "MATRIX")
    {
        possibleQueryType += possibleMatrixQuery;
    }
    ...
    else if (possibleQueryType == "PRINTMATRIX")
    ...
    else
    {
        ...
        if(possibleQueryType == "GROUP") {
            possibleQueryType += tokenizedQuery[3];
        }
        ...
        else if (possibleQueryType == "GROUPBY")
